...
test.describe('empty results', () => {
  test('[E2E-REG-014] a route with no scheduled flights shows the no-results message', async ({ page }) => {
  ...
  test('[E2E-REG-015] filtering an existing result set down to zero also shows the no-results message', async ({ page }) => {
    const date = futureDateIso(12);

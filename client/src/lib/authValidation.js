// Mirrors server/src/lib/authValidation.js so the form can show errors before
// ever hitting the API. The server remains the source of truth and re-validates.
